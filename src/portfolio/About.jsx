    ...
    <div className="row">
      ...
      <div className="col-md-8 col-md-offset-2">
        <div className="about-text">
          ...
          <p>I study smart grids and cybersecurity, therefore I have learned everything independently, I have spent the last few months improving my skills and continuing to learn new technologies. I'm not a designer, I just like to add functionality, connection between backend/frontend, and work with UX
</p>
